      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:gap-12">
          {features.map((feature) => (
            <div
              key={feature.number}
              className="grid md:grid-cols-2 gap-8 items-start p-6 lg:p-8 rounded-3xl bg-card border border-border"
            >
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-sm font-mono text-accent">[{feature.number}]</span>
                  <span className="text-sm text-muted-foreground uppercase tracking-wide">{feature.label}</span>
                </div>
                ...
                <div className="flex items-end gap-2">
                  <span className="text-5xl font-bold text-accent">{feature.stat}</span>
                  <span className="text-sm text-muted-foreground pb-2">{feature.statLabel}</span>
                </div>
              </div>
